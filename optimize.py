...
images_path = '/home/user/path/to/image_folder'


images_list = sorted([
    img_name for img_name in os.listdir(images_path) 
...
print("Saved calib_set.npy with", calib_dataset.shape[0], "images")

# Second, we will load our parsed HAR from the Parsing Tutorial

path_l = '/home/user/models/'
model_name = path_l+'model'
